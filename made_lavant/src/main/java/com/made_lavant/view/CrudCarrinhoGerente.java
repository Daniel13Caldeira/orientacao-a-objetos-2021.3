...
public class CrudCarrinhoGerente extends javax.swing.JFrame {
    ...
    public CrudCarrinhoGerente() {
        ...
        DefaultTableModel model = (DefaultTableModel) jTCarrinhosGerente.getModel();
    ...
    private void initComponents() {
        ...
        jTCarrinhosGerente = new javax.swing.JTable();
        ...
        jTCarrinhosGerente.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTCarrinhosGerente);
    ...
    private void confirmarBTN_CRCGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarBTN_CRCGActionPerformed
        if (jTCarrinhosGerente.getSelectedRow() != -1) {
            codigo = jTCarrinhosGerente.getValueAt(jTCarrinhosGerente.getSelectedRow(), 1).toString();
            this.setVisible(false);
    ...
    private javax.swing.JTable jTCarrinhosGerente;
