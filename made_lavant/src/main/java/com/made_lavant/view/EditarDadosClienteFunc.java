 ...
 * @author Marcio
 */
public class EditarDadosClienteFunc extends javax.swing.JFrame {

    /**
     * Creates new form EditarDadosClienteFunc
     */
    public EditarDadosClienteFunc() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarDadosClienteFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarDadosClienteFunc().setVisible(true);
            }
        });
    }
